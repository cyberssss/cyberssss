...
<div align="center">
    <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.herokuapp.com?font=Roboto+Slab&color=%237E3ACE&size=30&center=true&vCenter=true&width=450&lines=I'm+root>Cyber_Rajesh_Az;Cybersecurity;EthicalHacking;Pentesting;Computer+Engineering+Student;;MachineLearning;Algorithms;Hex(TEST)Binery;DeepCode's;AndroidDevelopers;SudoDevelopers;Brazilian+Front-end+Dev;Power+Metal+Lover+%3C3;function+findQuestion(42);Python<*>Lover>...Print;CodeBash" alt="Computer Engineering Student, Brazilian front-end developer, Power Metal lover, Python Lover"></a>
</div>
